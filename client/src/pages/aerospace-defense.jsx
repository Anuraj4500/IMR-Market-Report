...
const AerospaceDefense = () => {
    ...
    const description =
        "The aerospace and defense industry is a diverse sector that includes a wide range of products that are essential for daily life.";
