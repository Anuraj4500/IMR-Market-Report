...
const ElectronicsSemiconductors = () => {
    ...
    const description =
        "The electronics and semiconductors industry is a diverse sector that includes a wide range of products that are essential for daily life.";
