...
const EnergyNaturalResource = () => {
    ...
    const title = "Energy & Natural Resource";
    const description =
        "The energy and natural resource industry is a diverse sector that includes a wide range of products that are essential for daily life.";
