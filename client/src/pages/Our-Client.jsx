    ...
    useEffect(() => {
        const fetchClients = async () => {
            try {
                ...
                const response = await axios.get('https://imr-market-report-server.vercel.app/api/clients');
                        ...
                        {clients.map((client, index) => (
                            <div key={index} className="col-xl-2 col-lg-3 col-md-4 col-6">
                                <div className="client-logo-item style-three" data-aos="fade-up" data-aos-delay={200 * index} data-aos-duration="1000" data-aos-offset="50">
                                    <a href="#">
                                        <img src={`https://imr-market-report-server.vercel.app/uploads/${client.image}`} className="img-fluid" alt={client.title} />
                                    </a>
                                </div>
                            </div>
                        ))}
